...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/milkdrinkers/BoltUX")
        ...
        developers {
            developer {
                id.set("ShermansWorld")
                name.set("ShermansWorld")
                url.set("https://github.com/ShermansWorld")
        ...
        scm {
            url.set("https://github.com/milkdrinkers/BoltUX")
            connection.set("scm:git:git://github.com/milkdrinkers/BoltUX.git")
            developerConnection.set("scm:git:ssh://github.com:milkdrinkers/BoltUX.git")
        }
    }
