package io.github.milkdrinkers.boltux.config.migration;
...
public final class Migration implements ConfigurationTransformation {
    ...
    public static final class Builder {
         ...
         *
         * <p>For example, move {@code language} into {@code settings}, producing {@code settings.language}:
         ...
         *
         * <p>For example, move {@code old-key} to {@code section.new-key}:
