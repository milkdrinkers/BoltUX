...
public final class ProtectionAccessMenu extends AbstractGui {
    public static Gui generateBase() {
        Gui base = Gui.gui()
            .title(translate("boltux.gui.access.title"))
            .rows(3)
            .disableItemPlace()
            .disableItemSwap()
            .disableItemDrop()
    ...
    public static void generateButtons(Gui gui, Player player, Protection protection, Location protectionLocation) {
        ...
        addAccessButtonMeta.displayName(translate("boltux.gui.access.buttons.add.name", player));
        addAccessButtonMeta.lore(translateList("boltux.gui.access.buttons.add.lore", player));
        ...
        listRemoveAccessMeta.displayName(translate("boltux.gui.access.buttons.list.name", player));
        listRemoveAccessMeta.lore(translateList("boltux.gui.access.buttons.list.lore", player));
